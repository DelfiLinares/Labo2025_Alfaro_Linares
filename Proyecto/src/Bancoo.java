...
public class Bancoo {
    ...
    public static void main(String[] args) {
        PersonaBanco p1 = new PersonaBanco("Miguel", "Lopez", 32987990,
                LocalDate.of(1985, 10, 12), LocalDate.of(2020, 5, 8));
        PersonaBanco p2 = new PersonaBanco("Juana", "Gomez", 39987990,
                LocalDate.of(1986, 5, 28), LocalDate.of(2021, 3, 16));
        PersonaBanco p3 = new PersonaBanco("Candela", "Navarro", 40987990,
