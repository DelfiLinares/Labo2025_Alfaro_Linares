...
public class Partido {
    ...
    public static void main(String[] args) {
        ...
        p1.agregarMensajero(new Paloma("Negro","PalomaNegra","Londres",true, false));
        p1.agregarMensajero(new TelefonoMovil("Huawei","UWUWU",345, CompaniaTel.Claro, true, false));
